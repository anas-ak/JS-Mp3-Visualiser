...
            var a1 = p0 - 2.4 * p1 + 2 * p2 - 0.4 * p3;
            var a2 = -0.3 * p0 + 0.3 * p2;
...
    init(){
        this.analyser_1 = new Analyser(this, 0.7, "#704aba", 5, 1, 600, 2, 460, true);
...
        infoArea.textContent = fileName.substr(0, fileName.length-4);
    }
}
